...
class Tests {
    ...
    fun minContainingCircle() {
        ...
        val p7 = Point(0.3456787678, 34.4567678)
        val p8 = Point(4.0, 3.0)
        val result1 = minContainingCircle(p7, p8)
        listOf(p7, p8).forEach {
            assertTrue(result1.contains(it))
        }

 /*       val p10 = Point(2.220446049250313e-16, 0.07754315176704785)
        val p11 = Point(-632.0, 2.220446049250313e-16)
        val p12 = Point(-2.220446049250313e-16, 0.5332628772862515)
        val p13 = Point(-632.0, 0.9739799902796881)
        val p14 = Point(-632.0, 0.8698795990676232)
        val p15 = Point(0.4337898003856424, -5e-324)
        val p16 = Point(0.2686264674460308, 5e-324)
        val p17 = Point(0.42846253934080303, 0.8054020656135235)
        val p18 = Point(0.9652319849721014, 5e-324)
        val p19 = Point(-632.0, 0.8367932189881541)
        val p20 = Point(0.2718598065863368, 5e-324)
        val p21 = Point(-632.0, 0.05840739915733517)
        val p22 = Point(-632.0, 0.0)
        val p23 = Point(-632.0, -632.0)
        val p24 = Point(0.71064173760186, -2.220446049250313e-16)
        val p25 = Point(-632.0, -632.0)

        assertEquals(
            Circle(Point(-315.87010793050524, -315.5130100048602), 447.3277584680545),
            minContainingCircle(
